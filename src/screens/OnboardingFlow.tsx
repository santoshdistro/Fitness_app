    ...
    <div className="app-bg flex min-h-dvh flex-col px-6 pt-[max(1.5rem,env(safe-area-inset-top))] pb-[max(1.5rem,env(safe-area-inset-bottom))]">
      ...
      {current === 'review' ? (
        <button
          ...
          onClick={finish}
          disabled={saving}
          className="w-full rounded-2xl py-4 text-sm font-bold text-white disabled:opacity-50 bg-[linear-gradient(135deg,var(--accent),var(--accent-dark))]"
        >
        ...
        <button
          ...
          onClick={next}
          disabled={!canNext}
          className="w-full rounded-2xl py-4 text-sm font-bold text-white disabled:opacity-40 bg-[linear-gradient(135deg,var(--accent),var(--accent-dark))]"
        >
