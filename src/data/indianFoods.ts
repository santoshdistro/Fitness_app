...
const ROWS: Row[] = [
  ...
  ['Basmati rice', 'raw, 100 g', 100, 360, 7, 78, 1, 1, 5, 'chawal white'],
  ['Brown rice', 'raw, 100 g', 100, 362, 7, 76, 3, 4, 5, ''],
  ...
  ['Poha (flattened rice)', 'raw, 100 g', 100, 350, 7, 77, 1, 2, 5, 'chivda'],
  ...
  ['Oats', 'raw, 100 g', 100, 380, 13, 67, 7, 10, 5, ''],
  ['Sabudana (tapioca pearls)', 'raw, 100 g', 100, 350, 0, 87, 0, 1, 5, 'sago'],
  ['Toor / Arhar dal', 'raw, 100 g', 100, 340, 22, 57, 2, 15, 30, 'tuvar pigeon pea'],
  ['Moong dal', 'raw, 100 g', 100, 348, 24, 59, 1, 16, 30, 'green gram'],
  ['Masoor dal', 'raw, 100 g', 100, 350, 25, 60, 1, 11, 20, 'red lentil'],
  ['Chana dal', 'raw, 100 g', 100, 360, 20, 60, 5, 12, 40, 'split bengal gram'],
  ['Urad dal', 'raw, 100 g', 100, 341, 25, 59, 2, 18, 40, 'black gram'],
  ['Rajma (kidney beans)', 'raw, 100 g', 100, 333, 24, 60, 1, 15, 20, ''],
  ['Kabuli chana (chickpeas)', 'raw, 100 g', 100, 364, 19, 61, 6, 17, 24, 'white chana garbanzo'],
