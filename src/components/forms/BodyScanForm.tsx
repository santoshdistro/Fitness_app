          ...
          {stage.step === 'scanning' ? (
            ...
            <div className="w-full">
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl py-3 text-xs font-semibold text-white disabled:opacity-60 bg-[image:var(--accent-gradient)]"
              >
                <ImagePlus size={15} />
                {savePhoto === 'saved'
