...
export const submitButtonClass =
  'flex w-full items-center justify-center rounded-2xl py-3.5 text-sm font-semibold text-white disabled:opacity-40 bg-[linear-gradient(135deg,#6c63ff,#4b3fe0)] transition-transform active:scale-[0.98]';
