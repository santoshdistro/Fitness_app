...
export const submitButtonClass =
  'accent-lift flex w-full items-center justify-center rounded-2xl py-3.5 text-sm font-semibold text-white disabled:opacity-40 bg-[image:var(--accent-gradient)] transition-transform active:scale-[0.98]';
